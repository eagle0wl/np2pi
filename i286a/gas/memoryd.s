...
memp_read8:		ldr		r3, i2mr_cpu
				...
				ldrb	r0, [r3, r0]
				mov		pc, lr
i2mr_cpu:		.long 	i286acore + CPU_SIZE
...
memp_read16:		ldr		r3, i2mrw_cpu
				...
				ldrh	r0, [r3, r0]
				mov		pc, lr
i2mrw_cpu:		.long 	i286acore + CPU_SIZE
...
memp_write8:		ldr		r3, i2mw_cpu
				...
				strb	r1, [r3, r0]
				mov		pc, lr
i2mw_cpu:		.long 	i286acore + CPU_SIZE
...
memp_write16:	ldr		r3, i2mww_cpu
				...
				strh	r1, [r3, r0]
				mov		pc, lr
i2mww_cpu:		.long 	i286acore + CPU_SIZE
...
i2amrw_ext:		ldr		r2, i2amre_memfnrdw
				and		r12, r0, #(0x1f << 15)
				ldr		pc, [r2, r12, lsr #(15 - 2)]
i2amre_memfnrdw:	.long 	memfn + (32 * 4) * 2
...
i2amro_himeml:	ldreqb	r0, [r2, #-1]
				movne	r0, #0xff
i2amro_himemh:	orr		r0, r0, #0xff00
				mov		pc, lr
...
i2amw_ext:		cmp		r0, #USE_HIMEM
				...
				and		r12, r0, #(0x1f << 15)
				ldr		pc, [r2, r12, lsr #(15 - 2)]
i2amw_memfnwrb:	.long 	memfn + (32 * 4)
...
i2amww_ext:		ldr		r2, i2amwe_memfnwrw
				and		r12, r0, #(0x1f << 15)
				ldr		pc, [r2, r12, lsr #(15 - 2)]
i2amwe_memfnwrw:	.long 	memfn + (32 * 4) * 3
...
i2amwo_memfnwrb:	.long 	memfn + (32 * 4)
