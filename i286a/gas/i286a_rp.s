...
repnecmpsblp:	add		r0, r2, r11, lsr #16
				...
				cmp		r10, r0, lsl #24
				bne		repnecmpsblp
repnecmpsbbreak:		bic		r8, r8, #0xff
					subs	r1, r10, r0, lsl #24
					eor		r12, r1, r10
...
repnecmpswlp:	add		r0, r2, r11, lsr #16
				...
				cmp		r10, r0, lsl #16
				bne		repnecmpswlp
repnecmpswbreak:		bic		r8, r8, #0xff
					subs	r1, r10, r0, lsl #16
					eor		r12, r1, r10
					and		r3, r1, #(0xff << 16)
